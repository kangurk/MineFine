...
namespace MineFine
{
    ...
    public class ShopActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            {
                if (databaseDataHandler.UserData.Currency >= databaseDataHandler.pickaxes[databaseDataHandler.UserData.CurrentPickaxeIndex+1].Cost)
                {
                    databaseDataHandler.UserData.Currency -= databaseDataHandler.pickaxes[databaseDataHandler.UserData.CurrentPickaxeIndex + 1].Cost;
                ...
                {
                    Toast.MakeText(this, "You need "+ databaseDataHandler.pickaxes[databaseDataHandler.UserData.CurrentPickaxeIndex + 1].Cost+" gold coins to buy this item", ToastLength.Short).Show();
                }
            };
